    ...
    <section>
        ...
        <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
            <el-form :inline="true" :model="searchForm">
                <el-form-item>
                    <el-input v-model="keyWord" placeholder="寻主消息名称"></el-input>
                </el-form-item>
                <el-form-item>
                    <el-button type="primary" @click="superQuery">查询</el-button>
                </el-form-item>
                <el-form-item>
    ...
    export default {
        ...
        methods: {
            handleSuccess(response, file, fileList){
                ...
                //object 文件的服务器地址，放到数据库中
                //根据双向绑定 logo 就有值 1,2,3
                let resourcesTmp = '';
                if(fileList!=null && fileList.length>0){
                    for(var i=0;i<fileList.length;i++){
                        if(i==0){
                            resourcesTmp = resourcesTmp+fileList[i].response.object;
                        }else{
                            resourcesTmp = resourcesTmp+","+fileList[i].response.object;
                        }
                    }
            ...
            handle: function () {
                ...
                this.editForm.type_id = row.type.id;
                this.editForm.shop_id = row.shop.id;
                this.editForm.search_master_msg_id = row.id;
