    ...
    <section>
        ...
        <el-dialog :close-on-click-modal="false" :visible.sync="adoptOrderInfoVisible" title="订单详情">
            <el-form :model="adoptOrderInfo" label-width="120px" ref="adoptOrderInfo">
                ...
                <el-form-item label="收购状态" prop="state">
                    <template scope="scope">
                ...
                <el-form-item label="宠物名称" prop="manager">
                    <el-input auto-complete="off" readonly="readonly" v-model="adoptOrderInfo.pet.name"></el-input>
                </el-form-item>
                <el-form-item label="收购负责人" prop="parent">
                    <el-input auto-complete="off" readonly="readonly" v-model="adoptOrderInfo.employee.username"></el-input>
                </el-form-item>
                <el-form-item label="门店" prop="parent">
                    <el-input auto-complete="off" readonly="readonly" v-model="adoptOrderInfo.shop.name"></el-input>
                </el-form-item>
                <el-form-item label="地址" prop="parent">
                    <el-input auto-complete="off" readonly="readonly" v-model="adoptOrderInfo.address"></el-input>
                </el-form-item>
            </el-form>
    ...
    export default {
        ...
        methods: {
            ...
            getProductOrders: function () {
                ...
                this.$http.post("/petOrder/admin", para).then(res => {
                    res = res.data
            ...
            handleEdit: function (index, row) {
                ...
                this.$http.post("/petOrder/detail/" + row.id).then(res => {
                    res=res.data
                    if(res.success){
